...
<form id="form" name="form" action="${basePath }nsfw/reserve_deal.action" method="post" enctype="multipart/form-data">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td>
            <s:date name="reserve.replyTime" format="yyyy-MM-dd HH:mm"/>
		...
		<tr>
            ...
            <td><s:radio name="reserve.result" list="#{'1':'预约成功','2':'预约失败'}" value="1"/></td>
        </tr>
        <tr>
            <td class="tdBg" width="200px">回复内容：</td>
            <td><s:textarea name="reserve.content" cols="90" rows="8" /></td>
        </tr>
        <s:hidden name="reserve.reserveId"></s:hidden>
