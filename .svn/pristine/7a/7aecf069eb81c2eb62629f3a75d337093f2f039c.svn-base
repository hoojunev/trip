...
<head>
    ...
    var list_url = "${basePath}nsfw/reserve_listUI.action";
    //搜索
    function doSearch(){
    	$("#pageNo").val(1);
    ...
    //跳转到处理页面
    function doDeal(id){
    	document.forms[0].action="${basePath}nsfw/reserve_dealUI.action?reserve.reserveId=" + id;
    	document.forms[0].submit();
    }
        ...
        <div class="p_d_1_1">
            <div class="content_info">
                ...
                <div class="search_art">
                    <li>
                       	预约编号：<s:textfield name="reserve.reserveNo" cssClass="s_text"  cssStyle="width:160px;"/>
                    </li>
                    <li>
                    ...
                    <li>
                       	状态：<s:select name="reserve.result" list="#reserveStateMap" headerKey="" headerValue="全部"/>
                    </li>
