...
<head>
	...
	function doSelectAll(){
  	...
  	//新增
  	function doAdd(){
  		document.forms[0].action = "${basePath}travel/role_addUI.action";
  		document.forms[0].submit();
  	}
  	//编辑
  	function doEdit(id){
  		document.forms[0].action = "${basePath}travel/role_editUI.action?role.roleId=" + id;
  		document.forms[0].submit();
  		
  	}
  	//删除
  	function doDelete(id){
  		document.forms[0].action = "${basePath}travel/role_delete.action?role.roleId=" + id;
  		document.forms[0].submit();
  	}
  	//批量删除
  	...
  	var list_url = "${basePath}travel/role_listUI.action";
  	//搜索
  	function doSearch(){
