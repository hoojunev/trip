...
<form id="form" name="form" action="${basePath }travel/complain_deal.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
            ...
            <td colspan="2">
            	<s:iterator value="complain.complainReplies" status="st">
            		<fieldset style="border: solid 1px #c0c0c0;margin-top:5px;"><legend style="color:green;font-weight:bold;">回复<s:property value="#st.count"/>&nbsp;</legend>
						...
						<div style="width:100%;maring-top:10px;font-size:13px;padding-left:5px;"><s:property value="content" escape="false"/></div>
					</fieldset>
            	</s:iterator>
            </td>
        </tr>
