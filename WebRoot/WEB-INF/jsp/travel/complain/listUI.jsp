...
<head>
    ...
    <script type="text/javascript">
  	var list_url = "${basePath}travel/complain_listUI.action";
  	//搜索
  	function doSearch(){
  		$("#pageNo").val(1);
  	...
  	//受理
  	function doDeal(id){
  		document.forms[0].action = "${basePath}travel/complain_dealUI.action?complain.compId=" + id;
  		document.forms[0].submit();
  	}
  	//跳转到统计页面
  	function doAnnualStatistic(){
  		document.forms[0].action = "${basePath}travel/complain_annualStatisticChartUI.action";
  		document.forms[0].submit();  		
  	}
    </script>
</head>
