...
<head>
    ...
    function getDealDeptr(){
		...
		if(dept != ""){
    		...
    		$.ajax({
    			url:"${basePath}travel/reserveItem_getDealDeptr.action",
    			type:"post",
    ...
    //提交表单
    function doSubmit(){
    	document.forms[0].action = "${basePath}travel/reserveItem_add.action";
    	if($("#userId").val()==""){
    		alert("请选择处理人员");
    		return false;
    	}else{
...
<form id="form" name="form" action="${basePath}travel/reserveItem_add.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
